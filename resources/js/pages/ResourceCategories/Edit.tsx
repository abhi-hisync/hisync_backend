...
export default function EditResourceCategory() {
    const { category, parentCategories } = usePage<PageProps>().props;
    const [previewImage, setPreviewImage] = useState<string | null>(
        category.featured_image ? `/storage/${category.featured_image}` : null
    );
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/resource-categories/${category.id}/edit` },
    ];
    ...
    const { data, setData, put, processing, errors, reset } = useForm({
        ...
        is_featured: category.is_featured as boolean,
        sort_order: category.sort_order || 0,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/resource-categories/${category.id}`);
    };
    ...
    const handleNameChange = (name: string) => {
        ...
        if (data.meta_title === category.meta_title) {
                            ...
                            <Card className="p-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium">{category.resource_count}</p>
                                    </div>
                                    {category.parent && (
                                        <div>
